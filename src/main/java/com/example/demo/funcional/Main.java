...
public class Main {
	...
	public static void main(String[] args) {
		...
		LOG.info(" Function M.Referenciados " + function2.aplicar(2));
		...
		IPersonaUnary<Integer> unary2= metodosReferenciados::agregar;
		LOG.info(" Unary M.Referenciados " + unary2.aplicar(2));
